...
-   Get the keys for the desired edition from [here](/docs/hwid#supported-products)
...
-   Follow the official Microsoft guide [here](https://learn.microsoft.com/en-us/windows-server/get-started/upgrade-conversion-options), you can get the required keys from [here](/docs/kms38#supported-products).

------------------------------------------------------------------------

## Troubleshooting

-   Check [here](/docs/change_edition_issues).