...
-   If you want to use it in Windows Pre-Activation then check [this](/docs/oem-folder) page for more details.
...
-   To change the edition through the command line, check [here](/docs/change_edition#manual-edition-change). We didn't automate it in MAS because it requires a reboot in some cases.
