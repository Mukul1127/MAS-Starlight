---
title: \"Get Genuine Office\" banner
---
...
**TL;DR** To solve it, use [MAS](/) or abbodi1406's [KMS_VL_ALL](https://github.com/abbodi1406/KMS_VL_ALL_AIO/) to activate Office.
...
-   Apart from this, they also detect if a registered KMS server is on their blacklist or not. As far as I know, the below 3 addresses are blacklisted.  
    `kms8.msguides.com` `kms9.msguides.com` `0.0.0.0` 
...
-   Use [MAS](/) or abbodi1406's [KMS_VL_ALL](https://github.com/abbodi1406/KMS_VL_ALL_AIO/) to activate Office.
...
1. Open command prompt as admin, enter the below commands and press enter:  
...
2. It will change the update channel to `Production::MEC | MonthlyEnterprise`
3. Make sure that Office starts updating with the last command.
