...
<Aside type="tip" title="Differences between IoT and Non-IoT Windows Enterprise LTSC">
...
| :------------------------------------- | :-------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **TPM / Secure boot / UEFI / 4GB RAM** | All required    | [Not Required](https://learn.microsoft.com/windows/iot/iot-enterprise/Hardware/System_Requirements?tabs=Windows11LTSC#optional-minimum-requirements) 🎉 <br /> Also not required by [IoT Enterprise 24H2 (Non-LTSC)](/genuine-installation-media/windows_11_links#windows-11-24h2-preview) |
...
| **$OEM$ Folder Support**     | Yes                                                                                                   | No [(More Info)](/docs/oem-folder)                                                                            |
