...
-   For these reason, we need to host files on 3rd party. You can check [here](/genuine-installation-media#verify-authenticity-of-files) on how to be sure that files are genuine.
